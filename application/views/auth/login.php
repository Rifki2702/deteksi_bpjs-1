        ...
        <div class="w-1/3 bg-blue-900 text-black p-10 mx-auto pb-10 flex items-center">
            <div class="text-center place-items-center w-full">
                <div class="h-16 w-16 bg-blue-700 rounded-full mx-auto flex items-center">
                    <svg class="w-14 h-14 text-black dark:text-white mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="bg-white p-24 w-full">
                ...
                <form action="" method="post">
                    ...
                    <div class="flex flex-col items-center justify-center">
	                    <input type="submit" value="Login" class="bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-800 w-80">
	                    <a href="<?php echo site_url('auth/register'); ?>" class="mt-4 bg-gray-400 text-white py-2 px-4 rounded-md hover:bg-gray-300 w-80 text-center">Daftar User Baru</a>
	                </div>
                </form>
            </div>
        </div>
